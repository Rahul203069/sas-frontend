...
export default function SpecialStatusCard({ 
  title, 
  value, 
  icon: Icon, 
  trend, 
  ...
  return (
    <div className="relative z-10 w-full h-full"> {/* full width + full height */}
      <Card className="group w-full h-full hover:shadow-lg hover:shadow-slate-200/50 transition-all duration-300 border-slate-200/60 overflow-visible">
